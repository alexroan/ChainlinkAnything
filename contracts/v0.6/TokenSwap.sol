...
library TokenSwap {
    ...
    function swap(
        ...
        address[] memory path = getTokenToLinkPath(from, to);
        ...
        require(amounts[1] >= toAmount, "Not enough LINK from swap");
    }

    function getTokenToLinkPath(address from, address to) private pure returns (address[] memory) {
